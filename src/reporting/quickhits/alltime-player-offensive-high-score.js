...
const onlyOffensivePlayerHighScores = ({ trophy, details: { points } }) =>
  trophy && trophy.type === TT.WEEKLY_OFFENSIVE_PLAYER_HIGH_SCORE && points > 0;
...
export default () =>
  ACTIVITIES.filter(onlyOffensivePlayerHighScores)
    .sort(maxPointsSort)
