...
const onlyDefensiveHighScores = ({ trophy, details: { points } }) =>
  trophy && trophy.type === TT.WEEKLY_DEFENSIVE_PLAYER_HIGH_SCORE && points > 0;

export default () =>
  ACTIVITIES.filter(onlyDefensiveHighScores)
    .sort(maxPointsSort)
